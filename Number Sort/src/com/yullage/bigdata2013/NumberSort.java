...
public class NumberSort {
	...
	public static void main(String[] args) {
		...
		JobConf jobConf = new JobConf(NumberSort.class);
		...
		// Specify job name
		jobConf.setJobName("Number sort");
		...
		jobConf.setMapperClass(NumberSortMapper.class);
		jobConf.setReducerClass(NumberSortReducer.class);
